                    ...
                    <div class="nav-inner">
                        <nav class="navbar navbar-expand-lg    ">
                            <a class="navbar-brand" href="index.html">
                                <img src=" {{ URL::asset('frontend\assets\ADS-Logo_RGB.svg') }}" height="85px"
                                    alt="Logo">
                            </a>
                                ...
                                <ul id="nav" class="navbar-nav ms-auto">
                                    <li class="nav-item">
                                        <a class="{{ Route::currentRouteName() == 'Home' ? 'active' : '' }} "
                                            href="{{ route('Home') }}" aria-label="Toggle navigation">Home</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="{{ Route::currentRouteName() == 'Category' ? 'active' : '' }}"
                                            href="{{ route('Category') }}" aria-label="Toggle navigation">Product</a>
                                    </li>
                                    <li class="nav-item">
                            ...
                            <div class="login-button">
                                <ul>
                                    ...
                                    @guest
                                        <li>
                                            <a class="{{ Route::currentRouteName() == 'login' ? 'active_auth' : '' }}"
                                                href="{{ route('login') }}"><i class="lni lni-enter"></i> Login</a>
                                        </li>
                                        <li>
                                            <a class="{{ Route::currentRouteName() == 'Register' ? 'active_auth' : '' }}"
                                                href="{{ route('Register') }}"><i class="lni lni-user"></i> Register</a>
                                        </li>
                                    @endguest
                                </ul>
                            </div>
